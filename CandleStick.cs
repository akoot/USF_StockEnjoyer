...
{
    /// <summary>
    ///     Candle stick class. This class contains the Date, High, Low, Open, Close and Volume values of a typical
    ///     candlestick.
    ///     These values are meant to be read from a CSV file provided by Yahoo Finance.
    ///     Although Yahoo Finance has a slightly different format, you can still use their CSV files if you read them
    ///     correctly.
    ///     As shown below, the CandleStick class has six properties, each corresponding to one of the values needed to
    ///     represent a stock candlestick: date, open price, high price, low price, close price, and volume. These properties
    ///     are all public and have both getter and setter methods.
    ///     The constructor for the CandleStick class takes in six parameters: date, open, high, low, close, and volume.These
    ///     values are used to initialize the corresponding properties of the class.
    /// </summary>
